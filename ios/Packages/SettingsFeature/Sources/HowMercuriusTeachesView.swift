...
/// Pushed from Settings → About. Explains the three pedagogical principles
/// the tutor is built around so a student (or parent, or teacher) knows
/// what to expect.
///
/// Kept deliberately short — anyone who wants more detail will find it in
/// the full pedagogical-philosophy section of the README. It has no
/// `NavigationStack` or Done button of its own: the host's stack provides
/// the title bar and the back button.
public struct HowMercuriusTeachesView: View {
    public init() {}
    ...
    public var body: some View {
        ...
        .navigationTitle("How Mercurius teaches")
#if os(iOS)
...
#Preview("Light") {
    NavigationStack { HowMercuriusTeachesView() }
