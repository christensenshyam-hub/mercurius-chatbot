 ...
 *                               → a NEW array: every user message at index
 *                                 > 0 whose content is a string has its
 *                                 leading tag stripped (a new object, other
 *                                 fields preserved); index 0, assistant
 *                                 messages, and non-string (multimodal array)
 *                                 content pass through unchanged — same
 *                                 references, input never mutated. A
