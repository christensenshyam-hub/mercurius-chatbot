 ...
 * `curriculumVersion` is the client's `MercuriusCurriculum.version` (≥ 1).
 * `items` may be empty (a pull that also stamps the version); the cap of 200
 * is far above the ~45 lessons + 8 units that exist.
 */
