...
/**
 * `POST /api/chat`
 * The `model` field is NOT YET accepted — it'll be added in Phase 5c
 * alongside the allowlist. Adding it here early would let a crafted
 * client choose any model they want until the allowlist landed.
 */
