// Web version - uses navigator.clipboard instead of expo-clipboard
...
export function MessageActions({ visible, messageContent, onClose, onBookmark, onUnpack, onFlag }: Props) {
  ...
  const handleAction = async (actionId: string) => {
    switch (actionId) {
      ...
      case 'unpack': onUnpack(); break;
      case 'flag': onFlag(); break;
      case 'copy':
...
const styles = StyleSheet.create({
  ...
  sheet: { borderTopLeftRadius: 20, borderTopRightRadius: 20, borderWidth: StyleSheet.hairlineWidth, paddingBottom: 34, paddingTop: 12 },
  handle: { width: 36, height: 4, borderRadius: 2, alignSelf: 'center', marginBottom: 16 },
  title: { fontWeight: '600', letterSpacing: 1, paddingHorizontal: 20, marginBottom: 8 },
  actionRow: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 20, paddingVertical: 14, gap: 14 },
