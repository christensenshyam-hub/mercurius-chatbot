...
import { fetchReportCard } from '../../services/api';
...
export function ReportCardPanel({ visible, onClose }: Props) {
  ...
  useEffect(() => {
    if (visible && !report) {
      ...
      fetchReportCard(sessionId, msgHistory)
        .then(setReport)
        .catch(() => setReport('Could not generate report. Try again later.'))
        ...
        <View style={[styles.panel, { backgroundColor: colors.surface }]}>
          <View style={styles.header}>
            ...
            <View style={styles.headerRow}>
              <Icon name="bar-chart" size={20} color={colors.accent} />
