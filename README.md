...
A full-stack chatbot tutor designed to help high school students think critically about AI systems — including the one they're talking to. Built with Express, the Anthropic Claude API, and a self-contained vanilla JS/CSS widget that embeds on any website.
